...
return [
    ...
    */
    ...
    'providers' => [
        ...
        /*
         * LM Studio, running locally, speaking OpenAI's wire format. Both the
         * endpoint and the model are env values so swapping to a larger local
         * model — or to a hosted provider in production — is configuration
         * rather than a code change.
         */
        'lmstudio' => [
            'driver' => 'openai-compatible',
            'url' => env('LMSTUDIO_URL', 'http://127.0.0.1:1234/v1'),
            'models' => [
                'text' => [
                    'default' => env('LMSTUDIO_MODEL', 'google/gemma-4-e4b'),
                ],
            ],
        ],
